...
| 前端 | PRD、规则中心设计、技术设计 API 部分、角色分工 | 模板管理、规则管理、手动发送、发送记录、统计页 |
...
5. [后端 MVP 设计](backend-mvp-design.md)
6. [数据库与本地 Docker 环境](database-docker-prisma.md)
7. [阿里云短信测试配置](aliyun-sms-test-config.md)
8. `短信触达平台 V1 技术设计文档.pdf`
9. `短信触达平台 V1 - 事件定义文档.pdf`
10. `短信触达平台 V1 - 规则中心设计.pdf`
